    ...
    <div className="flex-col-12 flex pt-4  sm:pt-0 ">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {settingOtp && (
                <>
                  ...
                  <input type="checkbox" id="rememberMe" checked={keepLoggedIn} onClick={()=>setKeepLoggedIn(prev=>!prev)}/>
      ...
      <div className="hidden sm:block w-7/12 ">
        <div className="hidden sm:block w-full h-screen p-2">
          <img
            src="https://img.freepik.com/free-vector/bookcrossing-library-composition_1284-21973.jpg"
            alt=""
